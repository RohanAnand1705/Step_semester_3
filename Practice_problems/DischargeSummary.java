public class DischargeSummary {
    ...
    public static void main(String[] args) {
        ...
        String[] codes = d2.getMedicationCodes();

        codes[0] = "TAMPERED";

        System.out.println(
                d2.getMedicationCodes()[0]);

        // With-style correction
        DischargeSummary d3 = d2.withCorrectedMedication(
                0,
                "MED-C");

        System.out.println(
                d3.getMedicationCodes()[0]);
